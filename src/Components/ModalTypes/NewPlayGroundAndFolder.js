      ...
      <div className="px-6 py-4 mb-8 flex flex-col items-center justify-center gap-6">
        ...
        <div className="flex w-full">
          ...
          <input
            ...
            className="border-[0.5px] text-sm border-gray-50 rounded-lg p-2 w-full"
          />
        </div>
        <div className="flex w-full">
        ...
        />
        <button
          className="p-3 w-36 text-black rounder-lg font-semibold border-[0.5px] border-gray-50 shadow-lg"
          onClick={() => {
